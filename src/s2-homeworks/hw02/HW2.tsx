...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType) : Array<AffairType> => { // need to fix any
 affairs.map(a => a.priority === filter ? {...a,filter: filter}: a)
    if(filter === 'all') {
        return affairs
    } else {
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => { // need to fix any
        //в callBack функции удаления дел - сетаем саму функцию deleteAffair , а в параметрах передаем изначальный список дел affair , и _id
